                ...
                <div class="container kartu">
                    <div class="row">
                        ...
                        <table class="table">
                            ...
                            <tr>
                                <td class="tumbnail-img align-items-center">
                                    <img class="img" src="views/image/<% out.print(rs.getString("gambar")); %>" width="150" alt="..." />
                                </td>
                                <td><p><% out.print(rs.getString("nama")); %></p></td>
                                <td><p>Rp<% out.print(rs.getString("harga")); %></p></td>
                                <td><p><% out.print(rs.getString("iduser")); %></p></td>
                                <td>
                                    <form class="form-inline align-items-center" method="post" action="Delete">
